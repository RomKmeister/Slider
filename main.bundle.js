...
var map = {
	"./blocks/slider-block/init.js": "./src/blocks/slider-block/init.js",
	"./blocks/slider-block/slider-block.js": "./src/blocks/slider-block/slider-block.js"
};
...
var map = {
	...
	"./plugin/View/ViewBubbles.ts": "./src/plugin/View/ViewBubbles.ts",
	"./plugin/View/ViewHandles.ts": "./src/plugin/View/ViewHandles.ts",
	"./plugin/View/ViewPanel.ts": "./src/plugin/View/ViewPanel.ts",
	"./plugin/View/ViewScale.ts": "./src/plugin/View/ViewScale.ts",
	"./plugin/View/ViewSlider.ts": "./src/plugin/View/ViewSlider.ts",
...
/***/ "./src/blocks/slider-block/init.js":
/*!*****************************************!*\
  !*** ./src/blocks/slider-block/init.js ***!
  \*****************************************/
/*! no exports provided */
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _slider_block__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./slider-block */ "./src/blocks/slider-block/slider-block.js");
...
$(() => {
  ...
  $slider.each((index, item) => {
    new _slider_block__WEBPACK_IMPORTED_MODULE_0__["default"]($(item));
  });
});
...
/***/ "./src/blocks/slider-block/slider-block.js":
/*!*************************************************!*\
  !*** ./src/blocks/slider-block/slider-block.js ***!
  \*************************************************/
...
var Model = /** @class */ (function () {
    ...
    Model.prototype.calculateRatios = function (options) {
        ...
        var scaleLength = maxValue - minValue;
        var firstValueRatio = (firstValue - minValue) * (100 / scaleLength);
        var secondValueRatio = (secondValue - minValue) * (100 / scaleLength);
        var interval = (secondValue - firstValue) / 2;
        var firstValueArea = firstValue + interval;
    ...
    Model.prototype.correctMinMax = function (options) {
        ...
        var isValuesHigherMax = isSecondValueVisible && firstValue >= maxValue && secondValue >= maxValue;
...
/***/ "./src/plugin/View/ViewBubbles.ts":
/*!****************************************!*\
  !*** ./src/plugin/View/ViewBubbles.ts ***!
  \****************************************/
/*! no static exports found */
...
var ViewBubbles = /** @class */ (function () {
    ...
    ViewBubbles.prototype.setDirection = function () {
    ...
    ViewBubbles.prototype.setVisibility = function () {
...
/***/ "./src/plugin/View/ViewHandles.ts":
/*!****************************************!*\
  !*** ./src/plugin/View/ViewHandles.ts ***!
  \****************************************/
/*! no static exports found */
...
var ViewHandles = /** @class */ (function () {
    ...
    ViewHandles.prototype.setHandlersParameters = function () {
        this.setHandlesPosition();
        this.setVisibility();
        this.setDirection();
    };
    ViewHandles.prototype.init = function () {
        this.eventEmitter = new EventEmitter_1.default();
        this.findElements();
    ...
    ViewHandles.prototype.bindEventListners = function () {
        var _this = this;
        this.handles.forEach(function (item) { return item.addEventListener('mousedown', _this.handleHandleMouseDown.bind(_this)); });
        this.handleDocumentMouseMove = this.bindedHandleDocumentMouseMove.bind(this);
        document.addEventListener('mouseup', this.handleDocumentMouseUp.bind(this));
    };
    ViewHandles.prototype.handleHandleMouseDown = function (event) {
        event.preventDefault();
    ...
    ViewHandles.prototype.bindedHandleDocumentMouseMove = function (event) {
        var coordinate = this.model.modelOptions.isVertical ? event.clientY : event.clientX;
        var name = (this.target === this.firstHandle) ? 'firstValue' : 'secondValue';
        var newOptions = { target: name, newCoordinate: coordinate };
    ...
    ViewHandles.prototype.setVisibility = function () {
    ...
    ViewHandles.prototype.setDirection = function () {
...
var ViewPanel = /** @class */ (function () {
    function ViewPanel(element, model) {
        this.element = element;
        this.model = model;
        this.init();
    }
    ViewPanel.prototype.setPanelParameters = function () {
        ...
        this.inputs.forEach(function (item) {
            ...
            if (item.type === 'checkbox') {
                item.checked = Boolean(_this.model.modelOptions[newValue]);
            }
            else {
                item.value = String(Math.round(Number(_this.model.modelOptions[newValue])));
            }
        });
    };
    ViewPanel.prototype.init = function () {
        this.eventEmitter = new EventEmitter_1.default();
        this.findElements();
    ...
    ViewPanel.prototype.bindEventListners = function () {
        var _this = this;
        this.inputs.forEach(function (item) {
            item.addEventListener('change', _this.handleInputChange.bind(_this));
        });
    };
    ViewPanel.prototype.handleInputChange = function (event) {
        var _a;
        var target = event.currentTarget;
        var elementName = target.name;
        var elementValue = target.type === 'number' ? Number(target.value) : target.checked;
        var newOptions = __assign(__assign({}, this.model.modelOptions), (_a = {}, _a[elementName] = elementValue, _a));
...
var ViewScale = /** @class */ (function () {
    ...
    ViewScale.prototype.init = function () {
        this.eventEmitter = new EventEmitter_1.default();
        this.findElements();
        this.bindEventListners();
    };
    ...
    ViewScale.prototype.handleScaleMouseDown = function (event) {
        event.preventDefault();
        var coordinate = this.model.modelOptions.isVertical ? event.clientY : event.clientX;
        var newOptions = { target: 'scale', newCoordinate: coordinate };
        this.eventEmitter.notify(newOptions, 'scaleClicked');
    };
    ViewScale.prototype.handleStepMouseDown = function (event) {
        event.preventDefault();
        var target = event.target;
        var coordinate = 0;
        ...
        var newOptions = { target: 'value', newCoordinate: coordinate };
        this.eventEmitter.notify(newOptions, 'stepClicked');
    };
    ViewScale.prototype.setDirection = function () {
        var scaleClassDirection = 'slider__scale_vertical';
        var stepsClassDirection = 'slider__steps_vertical';
        if (this.model.modelOptions.isVertical) {
    ...
    ViewScale.prototype.setVisibility = function () {
        var stepClassVisibility = 'slider__steps_visible';
    ...
    ViewScale.prototype.setBorders = function () {
        this.minBorder.textContent = String(this.model.modelOptions.minValue);
    };
    ViewScale.prototype.countScaleSteps = function () {
        this.findElements();
        var _a = this.model.modelOptions, minValue = _a.minValue, maxValue = _a.maxValue, step = _a.step, isVertical = _a.isVertical;
        var minValueSymbols = String(minValue).length;
        var maxValueSymbols = String(maxValue).length;
        var stepSymbolSize = isVertical ? this.minBorder.clientHeight : this.minBorder.clientWidth;
        var scaleLength = isVertical ? this.scale.clientHeight : this.scale.clientWidth;
        ...
        var stepsItemsNumber = Math.round((maxValue - minValue) / step);
        var count = Math.round(stepsItemsNumber / (maxStepItems));
        var stepValue = (count <= 1) ? step : count * step;
        var maxIndex = Math.round((maxValue - minValue) / stepValue);
        var steps = [];
    ...
    ViewScale.prototype.createStepItems = function () {
        var _this = this;
        var _a = this.model.modelOptions, minValue = _a.minValue, maxValue = _a.maxValue, isVertical = _a.isVertical, scaleLength = _a.scaleLength;
        var steps = this.countScaleSteps();
        var fragment = document.createDocumentFragment();
        steps.forEach(function (value, index) {
            var valueRatio = (value) * (100 / scaleLength);
            var stepElement = document.createElement('p');
            stepElement.classList.add('slider__step');
            var lastStepValue = (index === steps.length - 1) ? maxValue : (value + minValue);
...
Object.defineProperty(exports, "__esModule", { value: true });
var EventEmitter_1 = __webpack_require__(/*! ../EventEmitter/EventEmitter */ "./src/plugin/EventEmitter/EventEmitter.ts");
var ViewScale_1 = __webpack_require__(/*! ./ViewScale */ "./src/plugin/View/ViewScale.ts");
var ViewBubbles_1 = __webpack_require__(/*! ./ViewBubbles */ "./src/plugin/View/ViewBubbles.ts");
var ViewHandles_1 = __webpack_require__(/*! ./ViewHandles */ "./src/plugin/View/ViewHandles.ts");
var ViewSlider = /** @class */ (function () {
    ...
    ViewSlider.prototype.update = function (data, event) {
        ...
        var newOption = __assign(__assign({}, this.model.modelOptions), (_a = {}, _a[name] = newValue, _a));
        this.eventEmitter.notify(newOption, 'viewSliderUpdated');
    };
    ViewSlider.prototype.init = function () {
        this.eventEmitter = new EventEmitter_1.default();
        this.viewScale = new ViewScale_1.default(this.element, this.model);
        this.viewHandles = new ViewHandles_1.default(this.element, this.model);
        this.viewBubbles = new ViewBubbles_1.default(this.element, this.model);
    ...
    ViewSlider.prototype.calculateValue = function (coordinate) {
        this.getScaleSizes();
        var LIQUID_MOVE = 0.01;
        var step = this.model.modelOptions.step > 1 ? this.model.modelOptions.step : LIQUID_MOVE;
        var value = this.model.modelOptions.minValue
    ...
    ViewSlider.prototype.chooseValueForUpdate = function (newValue) {
        var _a = this.model.modelOptions, isSecondValueVisible = _a.isSecondValueVisible, firstValueArea = _a.firstValueArea;
...
(function ($) {
    $.fn.sliderPlugin = function (options, method) {
        if (method === void 0) { method = 'init'; }
        var $this = this;
        var model;
        if (method === 'init') {
            var defaultOptions = {
            ...
            var elements = this[0];
            model = new Model_1.default($finalOptions);
